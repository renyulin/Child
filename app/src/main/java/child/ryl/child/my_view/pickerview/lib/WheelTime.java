...
public class WheelTime {
    ...
    public void setPicker(int year, int month, int day, int h, int m) {
        ...
        wv_hours.setAdapter(new NumericWheelAdapter(6, 23));
    ...
    public String getTime() {
        ...
        sb.append((wv_year.getCurrentItem() + START_YEAR)).append("-").append((wv_month.getCurrentItem() + 1))
                .append("-").append((wv_day.getCurrentItem() + 1)).append(" ").append(wv_hours.getCurrentItem() + 6)
                .append(":").append(wv_mins.getCurrentItem());
        return sb.toString();
    }
}
