...
import child.ryl.child.my_view.view_util.SimpleSpringListener;
import child.ryl.child.my_view.view_util.Spring;
import child.ryl.child.my_view.view_util.SpringConfig;
import child.ryl.child.my_view.view_util.SpringSystem;
import child.ryl.child.my_view.view_util.SpringUtil;
...
public class MyToggleButton extends View {
    ...
    public void setup(AttributeSet attrs) {
        ...
        paint.setStrokeCap(Cap.ROUND);//如圆形样式Cap.ROUND或方形样式Cap.SQUARE
        ...
        offBorderColor = typedArray.getColor(R.styleable.MyToggleButton_offBorderColor, offBorderColor);
        onColor = typedArray.getColor(R.styleable.MyToggleButton_onColor, onColor);
        spotColor = typedArray.getColor(R.styleable.MyToggleButton_spotColor, spotColor);
        offColor = typedArray.getColor(R.styleable.MyToggleButton_offColor, offColor);
        borderWidth = typedArray.getDimensionPixelSize(R.styleable.MyToggleButton_borderWidthMy, borderWidth);
        defaultAnimate = typedArray.getBoolean(R.styleable.MyToggleButton_animate, defaultAnimate);
        typedArray.recycle();
